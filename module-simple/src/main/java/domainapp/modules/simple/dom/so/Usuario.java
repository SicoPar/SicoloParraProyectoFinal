...
public class Usuario implements Comparable<Usuario>, CalendarEventable {
	...
	public static Usuario withName(String name, String nombre,String documento,String telefono, String email) {
...
//	
	...
	@Getter
	@Setter
	@Property(optionality = Optionality.OPTIONAL,commandPublishing = Publishing.ENABLED, executionPublishing = Publishing.ENABLED)
